...
echo.
echo The monitor will import historical events from the last 7 days,
...
start "Windows Event Monitor" powershell.exe -ExecutionPolicy Bypass -NoExit -File "%~dp0collector\event_monitor.ps1" -LogNames "System,Application" -PollIntervalSeconds 10 -HistoricalDays 7
